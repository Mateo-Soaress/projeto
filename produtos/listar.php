...
if ($filtroNome) {
    $total_produtos = $produtoRepositorio->contarTotalFiltrado($filtroNome);
}
else {
...
$produtos = $produtoRepositorio->buscarPaginado($itens_por_pagina, $offset, $ordem, $direcao, $filtroNome);
        ...
        <section class="container-table">            
            <table border="1">
                <tr class="header-row">
                    ...
                    <th>Descrição</th>
                    <th>
                        <a href="<?= gerarUrlOrdenacao('preco', $pagina_atual, $ordem, $direcao, $itens_por_pagina, $filtroNome) ?>" style="color: inherit; text-decoration: none;">
                ...
                <?php foreach ($produtos as $produto): ?>
                    <tr>
                        ...
                        <td>
                            <form action="form.php?id=<?= $produto->getId() ?>" method="POST">                            
                                <input type="submit" value="Editar" class="botao-editar">
                            </form>
                        </td>
                        <td>
                            <form action="excluir.php" method="POST" onsubmit='return confirmarExclusao(<?= json_encode($produto->getNome()) ?>)'>
                                <input type="hidden" name="produtoId" id="produtoId" value="<?= $produto->getId() ?>" class="id-box">
            ...
            <a href="form.php" class="link-cadastrar">Cadastrar Produto</a>
